...
render_whole        MenuCog.svg               Game/Menu-Cog.png
wait
...
render_whole_scaled PinkMice/ShokoDeath.svg   Game/PinkMice/ShokoPinkDeath.png     $(($UNIT_LENGTH * 2))  $(($UNIT_LENGTH * 1))
...
render_whole_for_dpi ArrowButtonDownLDPI.svg raw ldpi    arrow_button_down.png
render_whole_for_dpi ArrowButtonDownMDPI.svg raw mdpi    arrow_button_down.png
render_whole_for_dpi ArrowButtonDownHDPI.svg raw hdpi    arrow_button_down.png
render_whole_for_dpi ArrowButtonDownHDPI.svg raw hdpi    arrow_button_down.png
render_whole_for_dpi ArrowButtonDownHDPI.svg raw xhdpi   arrow_button_down.png
render_whole_for_dpi ArrowButtonDownHDPI.svg raw xxhdpi  arrow_button_down.png
render_whole_for_dpi ArrowButtonDownHDPI.svg raw xxxhdpi arrow_button_down.png
wait
